...
<?php if($short_color == 'r'): ?>
            ...
            <a href="<?php echo site_url();?>/joint_dual_degree"><div class="ic-dot ic-bdot"></div></a>
            <a href="<?php echo site_url();?>/academic_exchange"><div class="ic-dot ic-ydot"></div></a>
  	    <a class="ic-down-icon"href="<?php echo site_url(); ?>/joint_dual_degree" style="opacity:1; transform: matrix(1,0,0,1,0,0);"></a>
<?php elseif($short_color == 'b'): ?>
            <a href="<?php echo site_url();?>/exchange_student"><div class="ic-dot ic-rdot"></div></a>
            <div class="ic-dot ic-bdot ic-bdot_checked"></div>
            <a href="<?php echo site_url();?>/academic_exchange"><div class="ic-dot ic-ydot"></div></a>
	    <a class="ic-down-icon"href="<?php echo site_url(); ?>/academic_exchange" style="opacity:1; transform: matrix(1,0,0,1,0,0);"></a>
<?php elseif($short_color == 'y'): ?>
            <a href="<?php echo site_url();?>/exchange_student"><div class="ic-dot ic-rdot"></div></a>
            <a href="<?php echo site_url();?>/joint_dual_degree"><div class="ic-dot ic-bdot"></div></a>
            <div class="ic-dot ic-ydot ic-ydot_checked"></div>
	    <a class="ic-down-icon"href="<?php echo site_url(); ?>/exchange_student" style="opacity:1; transform: matrix(1,0,0,1,0,0);"></a>
<?php endif; ?>
