...
<div class="page-inter_contract">
    ...
    <!--<a class="icon_down"href="<?php echo site_url(); ?>/studying_abroad" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="right_icon"></div></a>-->
        <div id="ic-container">
            <div class="subtitled ic-pagetitle">01 International Collaboration</div>
...
<?php wp_nav_menu (array('theme_location' => 'Menu8','container_class' => 'nav_menu','container_id' => 'nav_menu_1')); ?>
<?php //get_sidebar(); ?>
<?php get_footer(); ?>
