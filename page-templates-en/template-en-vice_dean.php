...
<div class="page-vice_dean">
    ...
    <div class="container mobile-vice_dean formobile">
        <div id="vice_dean-container">
            <div class="intro-littleTitle" style="margin-left: 15vw;">03  Vice Deans</div>
            <div class="vd-block vd-chen">
                <div class="vd-text_block vd-m1">
                    <div class="title vd-bigTitle">Prof. CHEN, YUNG-FU</div>
                    <div class="clear_both"></div>
            ...
            <div class="vd-block vd-yang">
                <div class="vd-text_block vd-m2">
                    <div class="title vd-bigTitle">Prof. YANG, YI-FAN</div>
                    <div class="clear_both"></div>
		...
		<a class="icon_up"href="<?php echo site_url(); ?>/en-dean" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="vd-left_icon"></div></a>
                <a class="icon_down"href="<?php echo site_url(); ?>/en-staff" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="right_icon"></div></a>
...
<?php wp_nav_menu (array('theme_location' => 'Menu7','container_class' => 'nav_menu','container_id' => 'nav_menu_4')); ?>
<?php //get_sidebar(); ?>
<?php get_footer(); ?>
