<?php
/*
 *Template Name:en-mainland_overseas_chinese
 */
?>
<?php get_header('en_header'); ?>
<div class="page-admissions">
		<a class="icon_up"href="<?php echo site_url(); ?>/en-international_admissions" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="left_icon"></div></a>
                <a class="icon_down"href="<?php echo site_url(); ?>/en-admissions" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="right_icon"></div></a>
    <div class="container">
        <div class="adm-container adm-container0">
            <div class="subtitled adm-l_title">03  International Programs</div>
	    <div class="adm-line"></div>
        <div class="rnl-item_block">
            <a href="http://www.nsrrc.org.tw/">
            <div class="rnl-item">
                <div class="rnl-item_icon"></div>
                <div class="rnl-item_cht subtitled">Incoming Exchange Program</div>
            </div>
            </a>
            <a href="https://www.nchc.org.tw/">
            <div class="rnl-item">
                <div class="rnl-item_icon"></div>
                <div class="rnl-item_cht subtitled">Incoming Short Term Research Program</div>
            </div>
            </a>
            <a href="http://www.ndl.narl.org.tw/about/intro">
            <div class="rnl-item">
                <div class="rnl-item_icon"></div>
                <div class="rnl-item_cht subtitled">NCTU Summer Program</div>
            </div>
            </a>
        </div>
<!--
            <div class="adm-chinese_text_block text formobile">本校學士、碩士、博士亦招收大陸地區學生，陸生招生窗口為大學校院招收大陸地區學生聯合招生委員會。報名者應設籍在北京、上海、浙江、江蘇、福建、廣東、湖北及遼寧8省市，報名碩、博士班報考資格應符合教育部認可名冊之學校學歷。本校系所相關諮詢請洽各系所，其他業務聯絡：教務處綜合組。</div>
...
-->            
            ...
            <a target="_blank" href="http://www.ia.nctu.edu.tw/bin/home.php?Lang=en">
                <p class="text adm-bottom_text adm-bottom_text4">Office of International Affairs</p>
            </a>
            <a target="_blank" href="http://www.nctu.edu.tw/admission-en">
                <p class="text adm-bottom_text">NCTU International Admissions</p>
            </a>
<!--
...
<?php wp_nav_menu (array('theme_location' => 'Menu11','container_class' => 'nav_menu','container_id' => 'nav_menu_3')); ?>
<?php //get_sidebar(); ?>
<?php get_footer(); ?>
