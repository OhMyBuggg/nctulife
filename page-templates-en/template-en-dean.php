...
<!--formobile-->
	<div id="vice_dean-container" class="formobile">
            <div class="dean-option-wrapper dean-height3 formobile">
                <div class="intro-littleTitle formobile">02 The Dean(2014.8-)</div>
                <div class="dean-bigTitle">Prof. LI,YAW-KUEN</div>
		...
		<a class="icon_up"href="<?php echo site_url(); ?>/en-intro" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="left_icon"></div></a>
                <a class="icon_down"href="<?php echo site_url(); ?>/en-vice_dean" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="right_icon_w"></div></a>
</div>
<script>
...
<?php wp_nav_menu (array('theme_location' => 'Menu7','container_class' => 'nav_menu','container_id' => 'nav_menu_2')); ?>
<?php //get_sidebar(); ?>
<?php get_footer(); ?>
