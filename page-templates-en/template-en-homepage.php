		...
		<div class="hp-container">
			...
			<div class="icon_down"><div class="right_icon"></div></div>
                        <div class="hp-newsheader">
                            ...
                            <div class="hp-newstitle">News</div>
			    ...
			    <?php
                                ...
                                <div class="hp-news_item_title">No posts!</div>
                            <?php
                            endif;
                            wp_reset_postdata();
                            ?>
                    ...
                    <div class="hp-news hp-news1"> <!-- news2 -->
                        ...
                        <div class="hp-newsheader">
                            ...
                            <div class="hp-newstitle">Awards & Honors</div>
                    ...
                    <div class="hp-news hp-news2"> <!-- news3 -->
                        ...
                        <div class="hp-newsheader">
                            ...
                            <div class="hp-newstitle">Academic Events</div>
                    ...
                    <div class="hp-news hp-news3"> <!-- news4 -->
                        ...
                        <div class="hp-newsheader">
                            ...
                            <div class="hp-newstitle">Liberal Arts & Science</div>
...
-->
	...
	<!--	<a href="http://188.166.179.62/gallery_list/?lang=en">-->
...
-->
            <a href="<?php echo site_url(); ?>/en-international_admissions">
            ...
            <div id="foot">
                ...
                <div id="foot-center">
                    ...
                    <hr class="ft-hr"/>
                    <div class="foot-font-4 foot-bottom" style="float:left;"> <a href="http://www.nctu.edu.tw/">NCTU</a> | <a target="_blank" href="http://188.166.179.62/wp-content/themes/nctu_cos/files/map.jpg">Campus Map</a> | <a target="_blank" href="http://188.166.179.62/wp-content/themes/nctu_cos/files/Directory.pdf">Directory</a> | <a href="http://cos.nctu.edu.tw/"> Old Version</a> 
                    <form class="foot-searchbox" action="<?php echo site_url();?>/search/?lang=en">
