<?php
/*
 *Template Name:en-regulations_and_forms
 */
?>
...
-->
        <a class="icon_down"href="<?php echo site_url(); ?>/en-conference_room" style="opacity:1; transform: matrix(1,0,0,1,0,0);"><div class="right_icon"></div></a>

    <div class="container container2">
<!--mobile-->
        <div class="rf-container">
            <div class="subtitled rf-l_title formobile">01</div>
	    <div class="rf-title mobilehidden">01 Regulations & Forms</div>
            <div class="rf-container-mobile">
                <div class="subtitle rf-b_title formobile">Regulations & Forms</div>
...
<!--
 ...
 --> 
	    ...
	    <div class="rf-item-title">Regulations</div>
            <div id="rf1" class="rf-item rf-inactive rf-bdot-inactive" data-num="1" data-rel="rf_block1_0">Faculty Promotion</div>
            <div id="rf2" class="rf-item rf-inactive rf-bdot-inactive" data-num="2" data-rel="rf_block2_0">Faculty Evaluation</div>
<!--            <div id="rf3" class="rf-item rf-inactive rf-bdot-inactive" data-num="3" data-rel="rf_block3_0">Research or Study Leave</div>
-->
            <div class="rf-item-title" style="margin-top: 5vh;">Forms</div>
            <div id="rf5" class="rf-item rf-inactive rf-ydot-inactive" data-num="5" data-rel="rf_block5_0">Faculty Promotion</div>
            <div id="rf6" class="rf-item rf-inactive rf-ydot-inactive" data-num="6" data-rel="rf_block6_0">Faculty Evaluation</div>
        </div>
...
<?php wp_nav_menu (array('theme_location' => 'Menu12','container_class' => 'nav_menu','container_id' => 'nav_menu_1')); ?>
<?php //get_sidebar(); ?>
<?php get_footer(); ?>
